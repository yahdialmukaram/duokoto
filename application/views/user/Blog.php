	...
	<div class="col-sm-8">
	 ...
	 <div class="col-sm-12 padding_all">
	  ...
	  <div class="col-sm-11 padding_all">
	   <div class="blog_5">
	    <ul>
		    <li class="well_7"><a href="details.html"><i class="fa fa-facebook"></i>Share</a></li>
			<li class="well_8"><a href="details.html"><i class="fa fa-twitter"></i>Tweet</a></li>
		</ul>
	   </div>
	  </div>
	 </div>
	 <div class="col-sm-12 padding_all">
	  <div class="blog_6">
	   <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odionec odio.Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum. Praesent mauris..Fusce nec tellus sed augue semper porta. Mauris massa. Vestibulum lacinia arcu eget nulla.</p>
	 ...
	 <div class="col-sm-12 padding_all">
	  <div class="col-sm-4 padding_all">
	   <div class="blog_7">
	    <h4><?=$value->judul?></h4>
	    <p><a href="details.html"><img src="<?=base_url();?>assets/images/<?=$value->image?>" width="100%"></a></p>
	   </div>
	  </div>
	  <div class="col-sm-8 padding_all">
	   <div class="blog_8">
	   <p><a href="details.html"></a><?=$value->isi?></p>
	  </div>
	  </div>
	 </div>
	 <?php endforeach;?>
