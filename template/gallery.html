   ...
   <div class="row">
    <div class="col-sm-12">
	 ...
	 <div class="col-sm-4 padding_all">
	  <div class="gallery_1">
                  <div class="ih-item square effect5 left_to_right"><a href="#">
                      <div class="img"><img src="img/43.jpg" width="100%" alt="img"></div>
                      <div class="info">
                        <h3>Dapibus Diam</h3>
                        <p>Consectetur Quis Nunc</p>
                      </div></a></div>
          </div>
	 </div>
	 <div class="col-sm-4 padding_all">
	  <div class="gallery_1">
                  <div class="ih-item square effect5 left_to_right"><a href="#">
                      <div class="img"><img src="img/44.jpg" width="100%" alt="img"></div>
                      <div class="info">
                        <h3>Dapibus Diam</h3>
                        <p>Consectetur Quis Nunc</p>
                      </div></a></div>
	 ...
	 <div class="col-sm-4 padding_all">
	  <div class="gallery_1">
                  <div class="ih-item square effect5 left_to_right"><a href="#">
                      <div class="img"><img src="img/45.jpg" width="100%" alt="img"></div>
                      <div class="info">
                        <h3>Dapibus Diam</h3>
                        <p>Consectetur Quis Nunc</p>
                      </div></a></div>
	 ...
	 <div class="col-sm-4 padding_all">
	  <div class="gallery_1">
                  ...
                  <div class="ih-item square effect15 left_to_right"><a href="#">
                      <div class="img"><img src="img/46.jpg" width="100%" alt="img"></div>
                      <div class="info">
                        <h3>Himenaeos Elit</h3>
	 ...
	 <div class="col-sm-4 padding_all">
	  <div class="gallery_1">
                  <!-- normal -->
                  <div class="ih-item square effect15 left_to_right"><a href="#">
                      <div class="img"><img src="img/47.jpg" width="100%" alt="img"></div>
                      <div class="info">
                         <h3>Himenaeos Elit</h3>
                        <p>Lorem Ipsum Dolor</p>
                      </div></a></div>
	 ...
	 <div class="col-sm-4 padding_all">
	  <div class="gallery_1">
                  <!-- normal -->
                  <div class="ih-item square effect15 left_to_right"><a href="#">
                      <div class="img"><img src="img/48.jpg" width="100%" alt="img"></div>
                      <div class="info">
                          <h3>Himenaeos Elit</h3>
                        <p> Lorem Ipsum Dolor</p>
                      </div></a></div>
	 ...
	 <div class="col-sm-4 padding_all">
	  <div class="gallery_1">
                  <div class="ih-item square effect5 left_to_right"><a href="#">
                      <div class="img"><img src="img/49.jpg" width="100%" alt="img"></div>
                      <div class="info">
                         <h3>Vestibulum Quis</h3>
                        <p>Integer Nec Odionec</p>
                      </div></a></div>
          </div>
	 </div>
	 <div class="col-sm-4 padding_all">
	  <div class="gallery_1">
                  <div class="ih-item square effect5 left_to_right"><a href="#">
                      <div class="img"><img src="img/50.jpg" width="100%" alt="img"></div>
                      <div class="info">
                        <h3>Vestibulum Quis</h3>
                        <p>Integer Nec Odionec</p>
                      </div></a></div>
	 ...
	 <div class="col-sm-4 padding_all">
	  <div class="gallery_1">
                  <div class="ih-item square effect5 left_to_right"><a href="#">
                      <div class="img"><img src="img/51.jpg" width="100%" alt="img"></div>
                      <div class="info">
                        <h3>Vestibulum Quis</h3>
                        <p>Integer Nec Odionec</p>
                      </div></a></div>
